...
OSINT_SKILL = Skill(
    ...
    body=(
        ...
        "(`site:`, `filetype:`) for exposed docs. For exposed-host / device discovery:\n"
        ...
        "syntax', do NOT scrape zoomeye.org, and do NOT retry a keyed API that already "
        "returned 401/403 - that is a 'set the key' step, not a wall.\n"

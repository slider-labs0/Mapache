...
DARKWEB_SKILL = Skill(
    ...
    body=(
        ...
        "3. To DISCOVER an address or mirror links, query a dark-web index over Tor with "
        "`tor_fetch`, not a clearnet search engine. Use AHMIA - its OFFICIAL, current "
        "endpoints (do not invent or reuse other addresses):\n"
        "     - onion: http://juhanurmihxlp77nkq76byazcldy2hlmovfu2epvl5ankdibsot4csyd.onion\n"
        "     - clearnet mirror: https://ahmia.fi\n"
        "   You MUST hit the SEARCH endpoint, not the homepage (the homepage returns no "
        "results): append `/search/?q=<terms>` (URL-encode the query), e.g. "
        "`tor_fetch http://juhanurmihxlp77nkq76byazcldy2hlmovfu2epvl5ankdibsot4csyd.onion"
        "/search/?q=dread+forum`. Then parse the .onion links from the results.\n"

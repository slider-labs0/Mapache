...
DARKWEB_SKILL = Skill(
    ...
    body=(
        ...
        "OFFLINE, the address is correct but the site is down (Dread is frequently "
        "DDoSed) - report that; do NOT keep retrying. Use `tor_fetch`/browser to open a "
        "specific live .onion, not to search.\n"

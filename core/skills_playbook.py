...
OSINT_SKILL = Skill(
    ...
    body=(
        ...
        "Certificate-Transparency subdomain enumeration) and `zoomeye_search(query=...)` "
        "(free-tier device/service search - the closest Shodan-search substitute; needs "
        "a free ZOOMEYE_API_KEY). Prefer these over giving up when Shodan is unavailable "
        "or too costly.\n"
